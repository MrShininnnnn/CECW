...
This repository mainly contains the Colorful Extended Cleanup World (CECW) dataset, a benchmark for compositional generalization investigation such as the work in [Revisit Systematic Generalization via Meaningful Learning](https://aclanthology.org/2022.blackboxnlp-1.6/).
